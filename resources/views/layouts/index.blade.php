                        ...
                        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                            ...
                            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                                <ul class="flex flex-col p-4 md:p-0 mt-4 font-semibold border text-xl rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                                    <li>
                                        <a href="#" class="{{ request()->is('/') ? 'block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0' : 'block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0' }}" {{ request()->is('/') ? 'aria-current="page"' : '' }}>Home</a>
                                    </li>
                                    <li>
            ...
            <div class="container">
                <div class="flex justify-center mx-3">
                    <div class="w-full sm:w-3/4 md:w-2/3 lg:w-1/2">
                        <h4 class="mb-3 text-4xl text-gray-600 font-extrabold wow fadeInUp" data-wow-delay="0.3s">Subscribe to our newsletter</h4>
                        <p class="mb-4 text-gray-600 leading-loose text-base wow fadeInUp" data-wow-delay="0.6s">Existing customized ideas through client-based deliverables. <br> Compellingly unleash fully tested outsourcing</p>
                        <form>
        ...
        <footer id="footer" class="bg-gray-800 py-16">
            <div class="container mx-auto">
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="mx-3 mb-8">
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="text-gray-300 text-base font-semibold mb-5 hover:text-blue-900">Testimonal</a></li>
                    ...
                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="mx-3 mb-8">
                            ...
                            <ul>
                                ...
                                <li><a href="#" class="text-gray-300 text-base font-semibold mb-5 hover:text-blue-900">Client Registeration</a></li>
                                <li><a href="#" class="text-gray-300 text-base font-semibold mb-5 hover:text-blue-900">API Registeration</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="mx-3 mb-8">
                            <h3 class="font-bold text-xl text-white mb-5">Policy</h3>
                            <ul>
                                <li><a href="#" class="text-gray-300 text-base font-semibold mb-5 hover:text-blue-900">Teams and Conditions</a></li>
            ...
            <div class="container">
              <div class="flex flex-wrap">
                <div class="w-full text-center">
                  <p class="text-gray-300 text-sm font-semibold">Designed and Developed by <a class="text-white duration-300 hover:text-blue-900" href="https://github.com/vickkykruz" rel="nofollow">Victor Chukwemeka</a> at <a class="text-white duration-300 hover:text-blue-900" href="https://alxafrica.com" rel="nofollow">ALX Africa</a></p>
                </div>
              </div>
            </div>
        </section>
